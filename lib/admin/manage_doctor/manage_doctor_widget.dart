...
/// Create a doctor management page, show all doctor name and details from the
/// firebase, have an edit and remove in very doctor row.
///
/// An add new doctor button at the top right
