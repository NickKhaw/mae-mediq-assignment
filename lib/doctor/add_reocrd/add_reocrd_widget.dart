...
class AddReocrdWidget extends StatefulWidget {
  ...
  static String routeName = 'Add_Reocrd';
  static String routePath = '/addReocrd';

  @override
  State<AddReocrdWidget> createState() => _AddReocrdWidgetState();
}

class _AddReocrdWidgetState extends State<AddReocrdWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddReocrdModel());
