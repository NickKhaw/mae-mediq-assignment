...
class DoctorDashbaordWidget extends StatefulWidget {
  ...
  static String routeName = 'Doctor_Dashbaord';
  static String routePath = '/doctorDashbaord';

  @override
  State<DoctorDashbaordWidget> createState() => _DoctorDashbaordWidgetState();
}

class _DoctorDashbaordWidgetState extends State<DoctorDashbaordWidget> {
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.pushNamed(DoctorBookingListPage.routeName);
                    },
                    borderRadius: BorderRadius.circular(16.0),
                    child: Container(
                  ...
                  Column(
                    ...
                    children: [
                      InkWell(
                        ...
                        highlightColor: Colors.transparent,
                        onTap: () async {
                          context.pushNamed(AddReocrdWidget.routeName);
                        },
                        child: Container(
                          width: double.infinity,
                          decoration: BoxDecoration(
                  ...
                  InkWell(
                    ...
                    highlightColor: Colors.transparent,
                    onTap: () async {
                      context.pushNamed(ChangeDepartmentWidget.routeName);
                    },
                    child: Container(
                      width: double.infinity,
                      decoration: BoxDecoration(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 4.0, 0.0, 0.0),
                              child: Text(
                                'Help patient change department',
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
