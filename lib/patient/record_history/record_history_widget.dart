...
import 'record_history_model.dart';
export 'record_history_model.dart';

/// Create a record history page for patient
///
/// -----------------------------------------------------
/// | 📄 Alex Tan                                       |
/// | 🆔 IC: 990101-10-5678                             |
...
class _RecordHistoryWidgetState extends State<RecordHistoryWidget> {
  late RecordHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecordHistoryModel());
  }
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'Check twice a day, follow up next week',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  font: GoogleFonts.inter(
